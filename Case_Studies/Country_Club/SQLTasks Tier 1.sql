...
/* Answer: SELECT * FROM `Facilities` WHERE `membercost` > 0.0; */


/* Q2: How many facilities do not charge a fee to members? */

/* Answer: SELECT COUNT(*) FROM `Facilities` WHERE `membercost` = 0.0;
There are 4 facilities that do no charge a fee to members.*/
...
(SELECT DISTINCT 
    ...
    JOIN `Members` ON Bookings.memid = Members.memid) AS subquery
...
/* Answer: in the file Part2.ipynb */
